...
const wave = function() {
  ...
  function toggleWater() {
    if (settings.water) {
      ...
      document.getElementById("sine_wave").setAttribute("filter", "none");
      document.getElementById("sine_wave").setAttribute("fill", "none");
      document.getElementById("sine_wave").setAttribute("stroke", "#000");
      document.getElementById("sine_wave").setAttribute("stroke-width", "2");
    } else {
      settings.water = true;
      document.getElementById("sine_wave").setAttribute("filter", "url(#displacementFilter)");
      document.getElementById("sine_wave").setAttribute("fill", "rgba(0,0,255,0.4)");
      document.getElementById("sine_wave").setAttribute("stroke", "rgba(255,255,255,0.5)");
      document.getElementById("sine_wave").setAttribute("stroke-width", "5");
    }
  }
