...
const potential2 = function (id) {
  ...
  function renderDynamicPlane(who) {
    const depth = 20000 / settings.totalCharges //scale of the z-direction
    const minimumRadius = 10 //larger means less spiky peaks //how much of the center of a spike do we skip?
