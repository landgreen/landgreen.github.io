...
function grav2(el) {
	...
	let speed = Math.min(Math.floor(document.getElementById("speed").value), 100)
	document.getElementById('speed').addEventListener("input", function() {
		speed = Math.min(Math.floor(document.getElementById("speed").value), 100)
	}, false);
	...
	q4[q4.length] = new Particle({
		x: 450,
		y: 450
	}, 500, 0,{x:0,y:vyOff},'#0b0')
	q4[q4.length] = new Particle({
		x: 350,
		y: 450
	}, 0.1,0,{x:0,y:-0.58},'#0fb')
