...
var settings = {
  ...
  x: 0,
  y: 0,
  Vx: 15 + Math.round(Math.random() * 10),
  Vy: 15 + Math.round(Math.random() * 15),
  height: 10,
...
document.getElementById("num1").addEventListener(
  "input",
  function() {
    settings.height = document.getElementById("num1").value;
...
var wall1 = Bodies.rectangle(
  settings.gapX + n / 2 + settings.ballRadius,
  1.5 * canvas.height - settings.height * scale + settings.ballRadius * scale * 2,
  n,
  canvas.height,
  {
    isStatic: true
...
var wall2 = Bodies.rectangle(
  settings.gapX + n / 2 + settings.ballRadius,
  0.5 * canvas.height - settings.height * scale - settings.ballRadius * scale * 2,
  n,
  canvas.height,
  {
    isStatic: true
