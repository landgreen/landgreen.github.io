...
function spawn(){
  spawnMass(200, 110, 120, 0, 20 + Math.round(Math.random() * 70), 0.8+Math.random()*0.2);
  spawnMass(500, 110, -120, 0, 20 + Math.round(Math.random() * 70), 0.8+Math.random()*0.2);
}
spawn();
    ...
    World.add(engine.world, [
      ...
      //   frictionStatic: 1,
      // }),
      Bodies.rectangle(canvas.width + offset - 50, canvas.height * 0.5, 50, canvas.height * 2 + 2 * offset, { //right
        isStatic: true,
        friction: 1,
        frictionStatic: 1,
        restitution: 1,
      }),
      Bodies.rectangle(-offset+50, canvas.height*0.5, 50, canvas.height * 2 + 2 * offset, {  //left
        isStatic: true,
        friction: 1,
        frictionStatic: 1,
        restitution: 1,
