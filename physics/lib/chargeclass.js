...
class Charge { //charge class
    ...
    static pushZone(who, offx = 0, push = 0.1) {
        ...
        for (let i = 0, len = who.length; i < len; ++i) {
            if (who[i].electron &&
                who[i].position.x < range.max.x && who[i].position.x > range.min.x &&
                who[i].position.y < range.max.y && who[i].position.y > range.min.y
            ) {
    ...
    static scalarField(who, fieldSpacing = 3, fieldMag = 1000) {
        ...
        const chroma = [
            ...
            '#880000', '#8b0000', '#8f0001', '#930001', '#960001', '#9a0002', '#9d0002', '#a10002', '#a40002', '#a80002', '#ac0002', '#af0002', '#b30002', '#b70002', '#bb0002', '#be0002', '#c20002', '#c60002', '#c90002', '#cd0002', '#d10002', '#d50002', '#d90002', '#dc0001', '#e00001', '#e40001', '#e80001', '#ec0001', '#f00001', '#f40001', '#f80000', '#fc0000', '#ff0200', '#ff1300', '#ff1e00', '#ff2500', '#ff2c00', '#ff3200', '#ff3700', '#ff3c00', '#ff4000', '#ff4400', '#ff4800', '#ff4c00', '#ff5000', '#ff5300', '#ff5600', '#ff5a00', '#ff5d00', '#ff6000', '#ff6300', '#ff6600', '#ff6900', '#ff6c00', '#ff6f00', '#ff7100', '#ff7400', '#ff7700', '#ff7900', '#ff7c00', '#ff7f00', '#ff8100', '#ff8400', '#ff8600', '#ff8900', '#ff8c00', '#ff8e00', '#ff9100', '#ff9400', '#ff9700', '#ff9a00', '#ff9c00', '#ff9f00', '#ffa200', '#ffa500', '#ffa700', '#ffaa00', '#ffad00', '#ffaf00', '#ffb200', '#ffb500', '#ffb700', '#ffba00', '#ffbc00', '#ffbf00', '#ffc200', '#ffc400', '#ffc700', '#ffc900', '#ffcc00', '#ffcf00', '#ffd100', '#ffd400', '#ffd600', '#ffd900', '#ffdb00', '#ffdd0e', '#ffde22', '#ffdf30', '#ffe03b', '#ffe144', '#ffe24d', '#ffe355', '#ffe45d', '#ffe565', '#ffe66c', '#ffe773', '#ffe87a', '#ffe981', '#ffeb88', '#ffec8e', '#ffed95', '#ffee9b', '#ffefa2', '#fff0a9', '#fff1af', '#fff2b5', '#fff3bc', '#fff4c2', '#fff5c9', '#fff6cf', '#fff8d5', '#fff9dc', '#fffae2', '#fffbe9', '#fffcef', '#fffdf5', '#fffefc', '#fdfeff', '#f8fdff', '#f3fcff', '#eefbff', '#eafaff', '#e5f9ff', '#e0f8ff', '#dbf7ff', '#d6f6ff', '#d1f5ff', '#ccf4ff', '#c6f3ff', '#c1f2ff', '#bcf1ff', '#b6f0ff', '#b0efff', '#abeeff', '#a5edff', '#9fecff', '#98ebff', '#92eaff', '#8be9ff', '#84e7ff', '#7de6ff', '#75e5ff', '#6de4ff', '#64e3ff', '#5ae2ff', '#4fe1ff', '#42e0ff', '#31dfff', '#17ddff', '#04dbff', '#0ad9ff', '#0fd6ff', '#13d3ff', '#16d0ff', '#18ceff', '#1acbff', '#1bc8ff', '#1dc6ff', '#1ec3ff', '#1fc0ff', '#1fbeff', '#20bbff', '#20b8ff', '#21b6ff', '#21b3ff', '#20b0ff', '#20aeff', '#20abff', '#1fa8ff', '#1ea6ff', '#1da3ff', '#1ca0ff', '#1b9eff', '#199bff', '#1898ff', '#1596ff', '#1393ff', '#1091ff', '#0c8eff', '#078bff', '#0189ff', '#0686ff', '#0d83ff', '#1280ff', '#167dff', '#197aff', '#1b77ff', '#1d73ff', '#1f70ff', '#206dff', '#216aff', '#2267ff', '#2364ff', '#2461ff', '#245dff', '#245aff', '#2457ff', '#2453ff', '#2450ff', '#234cff', '#2248ff', '#2245ff', '#2141ff', '#1f3dff', '#1e39ff', '#1c34ff', '#1a30ff', '#182bff', '#1526ff', '#111fff', '#0d18ff', '#070fff', '#0102ff', '#0000fc', '#0000f8', '#0000f4', '#0000f0', '#0000ec', '#0000e8', '#0000e4', '#0000e0', '#0000dd', '#0000d9', '#0000d5', '#0000d1', '#0000cd', '#0000ca', '#0000c6', '#0000c2', '#0000be', '#0000bb', '#0000b7', '#0000b3', '#0000af', '#0000ac', '#0000a8', '#0000a5', '#0000a1', '#00009d', '#00009a', '#000096', '#000093', '#00008f', '#00008c', '#000088'
        ]
        ...
        for (let k = 0; k < lenY + 1; k++) {
            for (let j = 0; j < lenX + 1; j++) {
                ...
                if (thisHue != hue) { //only change color if the color is new
                    hue = thisHue;
