...
const spawn = {
    ...
    chaseShooter: function(x, y, radius=50) {
        mobs.spawn(x, y, 3, radius, 'rgba(140,100,250,', ['gravity', "seePlayerCheck", "fallCheck", 'fireAt']);
        //mob[mob.length - 1].repelMag = 0.0002;
	...
	laserer: function(x, y, radius=15) {
		...
		mob[mob.length - 1].repulsionRange = 600000;
    ...
    ghoster: function(x, y, radius=200) {
    ...
    sneakAttacker: function(x, y, radius=50) {
