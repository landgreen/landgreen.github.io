...
const mobs = {
    ...
    spawn: function(xPos, yPos, sides, radius, color, accelMag, methods) {
        let i = mob.length;
        mob[i] = Matter.Bodies.polygon(xPos, yPos, sides, radius, {
            ...
            seePlayerCheck: function() { //checks if the mob can see the player, but map and body objects block view
                if (!(game.cycle % 29) && this.distanceToPlayer2() < 2000000) { //view distance = 1414
